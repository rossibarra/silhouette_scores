...
#### Set up admix graph
Set Tree
```{r set tree, fig.height=1.5, fig.width=2, results="hide"}
...
bob=plot_tree("~/Desktop/sandbox/silhouette/treemix_out")
...
Make tree
```{r}
system("~/src/treemix/src/treemix -i ~/Desktop/sandbox/silhouette/treemix_cut_input.txt.gz -o treemix_cut_out -m 1")
bob=plot_tree("~/Desktop/sandbox/silhouette/treemix_cut_out")
...
Fit graphs, plot graph with lowest error.
```{r}
ncores=3 #cpu to use
